 ...
 const Delivery = () => {
   return (
    ...
    <div className='w-[1620px] mx-auto grid md:grid-cols-2'>
...
" alt="" />
    <div className='flex flex-col justify-center'>
        ...
        <h1 className="md:text-4xl sm:text-3xl text-2xl font-bold py-2 text-orange-500">Lorem ipsum dolor sit.
        </h1>
        ...
        <button className="bg-black text-[#00df9a] w-[200px] rounded-md font-medium my-5 mx-auto md:mx-0 py-3 ">Get Started</button>
  </div>
    </div>
